const avatarColors = ['bg-purple-400', 'bg-pink-400', 'bg-yellow-400']
  ...
  return (
    <header className="flex items-center gap-4 px-6 py-4 bg-white border-b border-gray-100">
      ...
      <div className="flex-1 flex justify-center">
        <div className="relative w-full max-w-md">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 bg-gray-100 rounded-xl text-sm text-gray-600 placeholder-gray-400 outline-none focus:ring-2 focus:ring-purple-300"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        <div className="w-9 h-9 rounded-full bg-purple-500 flex items-center justify-center text-white font-semibold text-sm shrink-0">
          PJ
        </div>
